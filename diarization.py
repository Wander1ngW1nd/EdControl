...
audio = AudioSegment.from_wav("audio.wav") # Указать откуда этот файл приходит
audio = spacer.append(audio, crossfade=0)
audio.export('input_prep.wav', format='wav')

pipeline = Pipeline.from_pretrained('pyannote/speaker-diarization', use_auth_token= ('access_token_hf') or True ) # Тут надо вписать токен с HuggingFace
